...
1. ENGINE OIL:
   ...
   - ACTION: Run `Search and Search2` tools for OEM specification, viscosity (e.g., 5W-40), and capacity in Liters.
...
2. TRANSMISSION / GEARBOX OIL (Huile de Boîte):
   ...
   - ACTION: Run `Search and Search2` tools for transmission specification (e.g., 75W-80 API GL-4 or ATF) and capacity in Liters.

3. OIL FILTERS (Filtres à Huile):
   - REQUIREMENT: Must collect exact same parameters as Engine Oil (Brand, Model, Year, Engine Code).
   - ACTION: Run `Search and Search2` tools to find the oil filter part reference/compatibility.
...
=== 4.
 - show both the results of Search and Search2 tools and compare between them , like tell me : this is the result of tool1 and this is of tool2 
 - for the Search2 tool , its response may need you to sumarize/parse it more 
---
